...
const peerToPeer = 'We have many teachers who are young and starting out in their\n' +
    ...
    'during the session.\n';
const affordable = 'We customize a tuition package for a parent depending on student\n' +
    'needs as found out during the assessment class and also depending\n' +
    'on the parents want';
const plus500 = 'We have proven we are the best agency, not only by the hundreds of students we' +
...
const studentRatio = 'Your child gets personalized attention; the teacher\'s primary focus is\n' +
